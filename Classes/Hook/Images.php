...
class Images {
	...
	public function getImageWidth($content = '', $conf = []) {
		...
		$collectionSettings = array_key_exists($collection, $this->collections) ? $this->collections[$collection] : $this->collections['default'];

		$width = array_key_exists($colPos, $collectionSettings['colPosWidths']) ? $collectionSettings['colPosWidths'][$colPos] : $collectionSettings['colPosWidths'][0];
		$factor = array_key_exists($imageorient, $collectionSettings['widthFactorByImageorient']) ? $collectionSettings['widthFactorByImageorient'][$imageorient] : 1;
		$width = $width * $factor;
